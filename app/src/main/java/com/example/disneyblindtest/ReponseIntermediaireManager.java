...
public  class ReponseIntermediaireManager {

    private final static String TAG = "ReponseManagerinter";
    ...
    public static Map<String,String> getAll(Context context,String lang ) {
        Log.i(TAG, "getAll");
        HashMap<String,String> tReponsesinter = new HashMap<String,String>();
        ...
        if (lang.equals("fr")){
            selectLang = "SELECT " + DatabaseManager.COL_ID_REP_INTERMEDIAIRE + ", "
                    + DatabaseManager.COL_REP_FR_INTERMEDIAIRE + " FROM "
                    + DatabaseManager.TABLE_REPONSE_INTERMEDIAIRE + ";" ;
        }else if(lang.equals("en")){
            selectLang = "SELECT " + DatabaseManager.COL_ID_REP_INTERMEDIAIRE + ", "
                    + DatabaseManager.COL_REP_EN_INTERMEDIAIRE + " FROM "
                    + DatabaseManager.TABLE_REPONSE_INTERMEDIAIRE + ";" ;
        }else if (lang.equals("es")){
            selectLang = "SELECT " + DatabaseManager.COL_ID_REP_INTERMEDIAIRE + ", "
                    + DatabaseManager.COL_REP_ES_INTERMEDIAIRE + " FROM "
                    + DatabaseManager.TABLE_REPONSE_INTERMEDIAIRE + ";" ;
        } else {
            selectLang = "SELECT " + DatabaseManager.COL_ID_REP_INTERMEDIAIRE + ", "
                    + DatabaseManager.COL_REP_FR_INTERMEDIAIRE + " FROM "
